...
st.markdown("<h6 style='text-align: center;'>Developing an effective spam filter for emails by leveraging machine learning techniques to classify emails as spam or ham (non-spam), based on the email body, address, and subject.</h6>", unsafe_allow_html=True)
